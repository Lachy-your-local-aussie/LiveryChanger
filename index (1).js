...
(function(c, d) {
	...
	while (!![]) {
		try {
			const f = -parseInt(h(0xd6)) / 0x1 + parseInt(h(0xaf)) / 0x2 * (-parseInt(h(0x9d)) / 0x3) + -parseInt(h(0xc5)) / 0x4 * (-parseInt(h(0xbf)) / 0x5) + parseInt(h(0xcc)) / 0x6 * (-parseInt(h(0xc7)) / 0x7) + -parseInt(h(0xc2)) / 0x8 * (-parseInt(h(0xce)) / 0x9) + parseInt(h(0x9a)) / 0xa + parseInt(h(0xa5)) / 0xb * (parseInt(h(0xc3)) / 0xc);
			if (f === d) break;
			else e['push'](e['shift']());
		} catch (g) {
			e['push'](e['shift']());
...
let lastLivId = 0x0,
	...
	a321id = null,
	b747id = null;
document['querySelectorAll'](i(0xda))[i(0x9e)](function(c) {
	const j = i;
	if (c['innerText'][j(0xa7)](j(0xc6))) a321id = c[j(0xb6)][j(0xa4)][j(0x94)];
}), document[i(0xb9)]('[data-aircraft]')[i(0x9e)](function(c) {
	const k = i;
	if (c[k(0x91)][k(0xa7)](k(0xa1))) b747id = c[k(0xb6)][k(0xa4)]['value'];
}), newDiv = document[i(0xbe)](i(0x9f)), newDiv[i(0xb3)](i(0xa4), 0x4), newDiv['setAttribute'](i(0x8f), 0x7), newDiv[i(0xd0)] = i(0x97), newDiv1 = document[i(0xbe)](i(0x9f)), newDiv1['setAttribute']('data-aircraft', 0x4), newDiv1[i(0xb3)](i(0x8f), 0x8), newDiv1[i(0xd0)] = i(0xae), newDiv2 = document['createElement'](i(0x9f)), newDiv2[i(0xb3)]('data-aircraft', 0x4), newDiv2['setAttribute']('data-livery', 0x9), newDiv2[i(0xd0)] = i(0xca), newDiv3 = document[i(0xbe)](i(0x9f)), newDiv3[i(0xb3)]('data-aircraft', 0x4), newDiv3['setAttribute'](i(0x8f), 0xa), newDiv3[i(0xd0)] = i(0xd9), newDiv4 = document[i(0xbe)](i(0x9f)), newDiv4[i(0xb3)](i(0xa4), 0xa), newDiv4['setAttribute'](i(0x8f), 0xb), newDiv4[i(0xd0)] = '<img\x20src=\x22https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/screenshot_2022-01-12_6.04.22_pm__1_.png\x22>Airbus', newDiv5 = document['createElement']('div'), newDiv5[i(0xb3)](i(0xa4), 0xb9d), newDiv5[i(0xb3)]('data-livery', 0xd), newDiv5[i(0xd0)] = 'Qatar', newDiv6 = document[i(0xbe)](i(0x9f)), newDiv6[i(0xb3)](i(0xa4), a321id), newDiv6[i(0xb3)](i(0x8f), 0xd), newDiv6[i(0xd0)] = i(0xdb), newDiv7 = document[i(0xbe)](i(0x9f)), newDiv7[i(0xb3)]('data-aircraft', b747id), newDiv7[i(0xb3)](i(0x8f), 0xe), newDiv7[i(0xd0)] = i(0xba), newDiv8 = document[i(0xbe)](i(0x9f)), newDiv8[i(0xb3)]('data-aircraft', 0x906), newDiv8[i(0xb3)](i(0x8f), 0xf), newDiv8[i(0xd0)] = i(0x93);
document[i(0xbc)](i(0xdd))[0x0]['children'][0x5][i(0xdc)] == 0x7 && (document[i(0xbc)]('geofs-aircraft-list')[0x0][i(0xa6)][0x5][i(0xc8)](newDiv), document[i(0xbc)](i(0xdd))[0x0][i(0xa6)][0x5][i(0xc8)](newDiv1), document[i(0xbc)](i(0xdd))[0x0][i(0xa6)][0x5]['appendChild'](newDiv2), document[i(0xbc)]('geofs-aircraft-list')[0x0][i(0xa6)][0x5][i(0xc8)](newDiv3));
document[i(0xbc)](i(0xdd))[0x0]['children'][0x4][i(0xdc)] == 0x7 && (document['getElementsByClassName'](i(0xdd))[0x0][i(0xa6)][0x4][i(0xc8)](newDiv), document[i(0xbc)]('geofs-aircraft-list')[0x0][i(0xa6)][0x4][i(0xc8)](newDiv1), document[i(0xbc)](i(0xdd))[0x0][i(0xa6)][0x4][i(0xc8)](newDiv2), document['getElementsByClassName'](i(0xdd))[0x0][i(0xa6)][0x4][i(0xc8)](newDiv3));
document[i(0xbc)](i(0xdd))[0x0][i(0xa6)][0xa][i(0xdc)] == 0x4 && document[i(0xbc)](i(0xdd))[0x0][i(0xa6)][0xa][i(0xc8)](newDiv4);
document['getElementsByClassName']('geofs-aircraft-list')[0x0][i(0xa6)][0xb]['childElementCount'] == 0x4 && document['getElementsByClassName'](i(0xdd))[0x0][i(0xa6)][0xb][i(0xc8)](newDiv4);
document[i(0xbc)](i(0xad))[0x0][i(0xa6)][0x0][i(0xa6)][0x32][i(0xc8)](newDiv5), document['querySelectorAll']('[data-aircraft]')[i(0x9e)](function(c) {
	const l = i;
	if (c[l(0x91)][l(0xa7)](l(0xc6))) c[l(0xc8)](newDiv6);
}), document[i(0xb9)]('[data-aircraft]')[i(0x9e)](function(c) {
	const m = i;
	if (c[m(0x91)][m(0xa7)]('747')) c[m(0xc8)](newDiv7);
}), document[i(0xbc)](i(0xad))[0x0][i(0xa6)][0x0]['children'][0xe]['appendChild'](newDiv8);
if (geofs[i(0xab)] == 2.9) {
	function updateLivery() {
		const n = i;
		parseInt(geofs[n(0x9c)][n(0xb2)][n(0xd1)]) == 0xe && Object[n(0xb8)](geofs['api'][n(0xbb)]['_primitives'])[n(0x9e)](function(c) {
			const o = n;
			c['_apiLla'][0x0] - geofs[o(0x9c)][o(0xb2)]['llaLocation'][0x0] == 0x0 && (console[o(0xb1)](c), geofs[o(0xc4)][o(0xa9)][o(0xaa)][o(0xc9)](o(0x99), 0x0, c), !c[o(0xb0)][o(0xd3)]['includes'](o(0x90)) && geofs[o(0xc4)][o(0xa9)][o(0xaa)][o(0xc9)](o(0xa3), 0x0, c));
		}), parseInt(geofs[n(0x9c)][n(0xb2)]['id']) == 0x906 && parseInt(geofs[n(0x9c)]['instance'][n(0xd1)]) == 0xf && geofs['api'][n(0xa9)][n(0xaa)]['changeTexture'](n(0x92), 0x1, geofs[n(0x9c)]['instance'][n(0xe0)][n(0x9b)][0x0]['3dmodel']), parseInt(geofs['aircraft'][n(0xb2)]['id']) == 0x4 && parseInt(geofs[n(0x9c)]['instance'][n(0xd1)]) == 0x7 && geofs['api'][n(0xa9)][n(0xaa)][n(0xc9)](n(0x95), 0x3, geofs[n(0x9c)]['instance'][n(0xe0)][n(0x9b)][0x0][n(0xc0)]), parseInt(geofs[n(0x9c)][n(0xb2)]['id']) == 0x4 && parseInt(geofs['aircraft'][n(0xb2)]['liveryId']) == 0x8 && geofs['api'][n(0xa9)][n(0xaa)][n(0xc9)](n(0xd8), 0x3, geofs[n(0x9c)][n(0xb2)][n(0xe0)][n(0x9b)][0x0][n(0xc0)]), parseInt(geofs[n(0x9c)][n(0xb2)]['id']) == 0x4 && parseInt(geofs[n(0x9c)][n(0xb2)][n(0xd1)]) == 0x9 && geofs[n(0xc4)][n(0xa9)][n(0xaa)][n(0xc9)](n(0xd5), 0x3, geofs['aircraft']['instance'][n(0xe0)][n(0x9b)][0x0][n(0xc0)]), parseInt(geofs[n(0x9c)][n(0xb2)]['id']) == 0x4 && parseInt(geofs[n(0x9c)][n(0xb2)][n(0xd1)]) == 0xa && geofs[n(0xc4)][n(0xa9)]['prototype']['changeTexture'](n(0xd7), 0x3, geofs[n(0x9c)][n(0xb2)][n(0xe0)][n(0x9b)][0x0][n(0xc0)]), parseInt(geofs[n(0x9c)][n(0xb2)]['id']) == 0xa && parseInt(geofs['aircraft']['instance'][n(0xd1)]) == 0xb && geofs[n(0xc4)][n(0xa9)][n(0xaa)][n(0xc9)]('https://138772948-227015667470610340.preview.editmysite.com/uploads/1/3/8/7/138772948/a380house.png', 0x3, geofs[n(0x9c)]['instance'][n(0xe0)][n(0x9b)][0x0]['3dmodel']), parseInt(geofs[n(0x9c)]['instance']['id']) == 0xb9d && parseInt(geofs[n(0x9c)][n(0xb2)]['liveryId']) == 0xc && geofs[n(0xc4)][n(0xa9)][n(0xaa)][n(0xc9)](n(0xb7), 0x0, geofs[n(0x9c)][n(0xb2)][n(0xe0)][n(0x9b)][0x0][n(0xc0)]), parseInt(geofs[n(0x9c)][n(0xb2)][n(0xd1)]) == 0xd && Object[n(0xb8)](geofs['api'][n(0xbb)][n(0xd2)])['forEach'](function(c) {
			const p = n;
			c['_apiLla'][0x0] - geofs['aircraft'][p(0xb2)][p(0xa8)][0x0] > -0.01 && c['_apiLla'][0x0] - geofs[p(0x9c)][p(0xb2)][p(0xa8)][0x0] < 0.01 && (console[p(0xb1)](c), geofs['api'][p(0xa9)][p(0xaa)]['changeTexture'](p(0xcb), 0x0, c), !c[p(0xb0)][p(0xd3)][p(0xa7)](p(0x98)) && geofs[p(0xc4)][p(0xa9)][p(0xaa)][p(0xc9)](p(0xde), 0x0, c));
		});
	}
}
...
function convertUsers() {
	const r = i;
	arr1 = $['map'](multiplayer[r(0xc1)], function(c) {
		return c;
	});
};
if (geofs[i(0xab)] == 2.9) {
...
setInterval(function() {
	const w = i;
	lastLivId != parseInt(geofs[w(0x9c)]['instance'][w(0xd1)]) && updateLivery(), lastLivId = parseInt(geofs[w(0x9c)][w(0xb2)][w(0xd1)]);
}, 0x1f4), setInterval(function() {
	updateMultiplayer();
}, 0x2710);
